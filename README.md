...
一個可部署至 GitHub Pages 的純前端個人連結 Dock。支援自訂背景圖片與色溫、帶動畫的分類收合、圖示／清單布局切換、連結備註、新增／編輯／刪除連結、Google Drive App Data 同步，以及 PIN 鎖定。
...
- 上傳圖片會轉換成 WebP，長邊最多 1920 像素；過大的圖片會再次縮小，以降低瀏覽器儲存與同步負擔。
